...
export function HexField({
   ...
   * still: enough to carry the motif onto interior pages without every one of
   * them competing for attention. A theme that shouts on every page is not a
   * theme, it is a distraction repeated.
   */
  variant = "hero",
}: {
  variant?: "hero" | "quiet";
        ...
        {cells.map((cell) => {
          ...
          return (
            <polygon
              ...
              // Interior pages get the lattice without the pulse: the motif is
              // the shape, not the motion.
