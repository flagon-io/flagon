  ...
  return (
    <ToggleGroupPrimitive.Item
      ...
      className={cn(
        ...
        "data-[state=on]:bg-secondary data-[state=on]:text-foreground focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
        className,
      )}
      {...props}
    />
