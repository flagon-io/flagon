...
- **Allowances are enforced.** Each plan includes a monthly exposure allowance
  ...
  its cap gets a `403` here and needs to upgrade to continue. Flag evaluation stays free
  and unaffected: only metering stops. Pro meters the overage at $0.03 per 1,000
  exposures instead of blocking.
