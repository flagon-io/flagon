              ...
              {NAV_ITEMS.filter((item) => item.href).map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={
                      active
                        ? "rounded-md bg-white/5 px-3 py-2.5 text-sm font-medium text-zinc-100"
                        : "rounded-md px-3 py-2.5 text-sm font-medium text-zinc-300 transition-colors hover:bg-white/5 hover:text-zinc-100"
                    }
                  >
                    {item.label}
                  </Link>
