 ...
 * it inherits the dark theme and fonts. Every error that lands here is reported to
 * Sentry (inert unless the DSN is set) with its digest.
 *
 ...
 * sign-out) leaves the session intact. The page below says so and offers a retry;
 * we deliberately do NOT also pop a toast — it was redundant with this page (and
 * fired twice when the boundary re-mounted).
 */
