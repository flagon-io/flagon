...
const TAG_DEFS: { name: string; description: string }[] = [
  ...
  { name: "Incidents", description: "Reliability events affecting catalog services, with a timeline and responders." },
  { name: "On-call", description: "On-call rotations (team or individual), overrides, and escalation policies." },
  { name: "Runbooks", description: "Reusable playbooks whose steps become an incident's checklist." },
  { name: "Notifications", description: "Your contact channels for incident paging (email, SMS, voice, push)." },
