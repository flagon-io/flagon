...
curl https://api.flagon.io/v1/me \\
  -H "Authorization: Bearer $JWT"`}</Pre>
      ...
      <P>
        These credentials are for the <em>management</em> API, which is what the rest of these docs
        cover. Capabilities like Feature Flags introduce their own credentials as they land.
      </P>
